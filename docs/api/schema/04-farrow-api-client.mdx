...
An client for [farrow-api-server](./03-farrow-api-server.mdx).
...
Using [farrow](../framework/01-farrow.mdx) to codegen the code for client, and config apiPipeline if needed.
