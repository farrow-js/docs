...
:::info
If you want to know more detail about Farrow API, see [RPC](../guide/rpc-server/base/schema.md).

If you want to know the design philosophy about Farrow API, see [Why RPC-like API](../philosophy/rpc-like.md) and [Why Schema Builder Based on TypeScript](../philosophy/schema-builder.md).
:::
...
:::info
If you want to know more detail about **Code generation** of Farrow API, see [Get code at Client](../guide/server-and-client/client.md).
